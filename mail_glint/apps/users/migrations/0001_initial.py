...
import mail_glint.apps.users.models.fields.phone_number
import mail_glint.apps.users.models.managers.active
import mail_glint.apps.users.models.managers.objects
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', mail_glint.apps.users.models.fields.phone_number.CustomPhoneNumberField(blank=True, max_length=20, null=True, region=None, verbose_name='전화')),
            ...
            managers=[
                ('objects', mail_glint.apps.users.models.managers.objects.UserMainManager()),
                ('active', mail_glint.apps.users.models.managers.active.UserActiveManager()),
            ],
        ),
    ]
